...
window.addEventListener('DOMContentLoaded', () => {                     //ожидание загрузки DOM-дерева, выполнит остальной код только после того как DOM-дерево сформируется. можно писать windows или document
    ...
    const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimerId), 50000);                  //таймер на вызов модального окна
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__.default)('.timer', '2021-01-31');
